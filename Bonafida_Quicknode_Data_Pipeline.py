...
api_key = os.getenv("QUICKNODE_BONFIDA_API_KEY")  # Retrieve API key for Bonfida
endpoint = os.getenv("QUICKNODE_ENDPOINT")  # Retrieve Quicknode endpoint

def query_bonfida_api(query):
    """Queries the Bonfida API on Quicknode with the provided query string.
    ...
    url = f"{endpoint}/api/v2/data"  # For Bonfida API on Quicknode
    headers = {
